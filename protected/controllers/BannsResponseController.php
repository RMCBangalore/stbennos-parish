...
class BannsResponseController extends RController
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('BannsResponse');
	...
	{
		$model=new BannsResponse('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['BannsResponse']))
			$model->attributes=$_GET['BannsResponse'];
	 ...
	 * @return BannsResponse the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=BannsResponse::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param BannsResponse $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='banns-response-form')
		{
