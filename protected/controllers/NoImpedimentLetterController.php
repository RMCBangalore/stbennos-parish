...
class NoImpedimentLetterController extends RController
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('NoImpedimentLetter');
	...
	{
		$model=new NoImpedimentLetter('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['NoImpedimentLetter']))
			$model->attributes=$_GET['NoImpedimentLetter'];
	 ...
	 * @return NoImpedimentLetter the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=NoImpedimentLetter::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param NoImpedimentLetter $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='no-impediment-letter-form')
		{
