...
class OpenDataController extends RController
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('OpenData');
	 ...
	 * @param OpenData $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='open-data-form')
		{
