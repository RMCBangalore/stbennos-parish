...
*/			array('allow', // allow admin user to perform 'admin' and 'delete' actions
	 ...
	 * @return BaptismCertificate the loaded model
	 ...
	 * @param BaptismCertificate $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='baptism-certificate-form')
		{
