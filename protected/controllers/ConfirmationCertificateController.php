...
class ConfirmationCertificateController extends RController
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('ConfirmationCertificate');
	...
	{
		$model=new ConfirmationCertificate('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ConfirmationCertificate']))
			$model->attributes=$_GET['ConfirmationCertificate'];
	 ...
	 * @param ConfirmationCertificate $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='confirmation-certificate-form')
		{
